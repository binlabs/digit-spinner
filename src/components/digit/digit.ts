 ...
 *
 * @cssprop [--digit-font-size] - The font size of the digit
 * @cssprop [--digit-background-color] - The background color of the digit
 * @cssprop [--digit-color] - The color of the digit
 * @cssprop [--digit-font] - The font stack of the digit
 *
